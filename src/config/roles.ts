...
export const roleConfigs: RoleConfig[] = [
  {
    ...
    needs: [
      "Strong angle discipline",
      "Reliable first contact",
      "Late-round composure",
      "Space from riflers",
    ],
    bestUse: [
      "Give them clear protocols",
      "Pair with a high-pressure rifler",
      "Avoid overpaying for a second pure AWP",
    ],
    rosterAdvice:
  ...
  },
  {
    ...
    needs: [
      "Trading support",
      "Utility behind them",
      "Confidence in first contact",
      "A structured caller",
    ],
    bestUse: [
      "Pair with star riflers",
      "Do not judge only by deaths",
      "Use them on high-entry maps",
    ],
    rosterAdvice:
  ...
  },
  {
    ...
    needs: [
      "Space from entries",
      "Good trade spacing",
      "Freedom in mid-rounds",
      "Utility support",
    ],
    bestUse: [
      "Use as a core damage piece",
      "Pair with a lower-cost support",
      "Give them maps with rifle pressure",
    ],
    rosterAdvice:
  ...
  },
  {
    ...
    bestUse: [
      "Use on rotation-heavy maps",
      "Pair with active pack players",
      "Avoid too many passive profiles together",
    ],
    rosterAdvice:
  ...
  },
  {
    ...
    bestUse: [
      "Prioritize on CT-sided maps",
      "Pair with aggressive rotators",
      "Do not overload roster with greedy stars",
    ],
    rosterAdvice:
  ...
  },
  {
    ...
    bestUse: [
      "Pair with premium stars",
      "Use to fix greedy rosters",
      "Value KAST and consistency over raw rating",
    ],
    rosterAdvice:
  ...
  },
  {
    ...
    needs: [
      "Mid-round clarity",
      "Role management",
      "Map pool understanding",
      "Enough firepower around them",
    ],
    bestUse: [
      "Pair with stars",
      "Do not overvalue raw stats",
      "Use to raise structure score",
    ],
    rosterAdvice:
  ...
  },
  {
    ...
    needs: [
      ...
      "Role discipline",
      "Map-to-map flexibility",
    ],
    bestUse: [
      "Use to complete role balance",
      "Pair with specialists",
      "Value consistency and hybrid weapon profile",
    ],
    rosterAdvice:
